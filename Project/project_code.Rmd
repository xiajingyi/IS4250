...
qplot(GenderX, ScoreX, data=healthDataTbl, geom=c("jitter"), 
   fill=GenderX, main="Lifestyle Score - Gender",
   xlab="", ylab="Lifestyle Score", color = 'red')

qplot(GenderX, data=healthDataTbl, geom="bar", fill=ScoreX, xlab="", ylab="Lifestyle Score")

densityplot(~healthDataTbl$Score|healthDataTbl$GenderX, 
  	main="Lifestyle Score - Gender",
   xlab="Lifestyle Score")
...
```{r,  message=FALSE, echo=FALSE}
COR = c(1.0, 1.0651334, 1.1669024, 0.9563699, 1.0786757, 1.3927085)
...
```{r,  message=FALSE, echo=FALSE}
COR = c(0.9747957, 1.0, 1.0039951, 1.1209372)
...
```{r,  message=FALSE, echo=FALSE}
COR = c(1.0, 0.9787387 , 1.1584592 , 1.1146430 , 1.1034555 , 1.6781331 )
Occupation = c("1Manufacturing", "2Construction", "3Hospitality", "4DomesticServices", "5SmallBusiness", "6Recreation/Leisures")
COROccupation = data.frame(COR,Occupation)
ggplot(COROccupation, aes(x = Occupation, y = COR, fill = Occupation)) + geom_bar(stat = "identity", width = 0.8)
```
...
```{r,  message=FALSE, echo=FALSE}
COR = c(1.0, 1.2135993 , 1.1061900 , 1.1118359 )
...
```{r,  message=FALSE, echo=FALSE}
COR = c(1.0, 0.9193689 , 0.9299730 , 1.1547884 )
...
```{r,  message=FALSE, echo=FALSE}
COR = c(1.0464129 , 1.0, 1.0785105 , 1.0507422 )
DailyWorkingHours = c("1.<8hr","2.=8hr","3.8-11hr","4.>=11hr")
CORDailyWorkingHours = data.frame(COR,DailyWorkingHours)
ggplot(CORDailyWorkingHours, aes(x = DailyWorkingHours, y = COR, fill = DailyWorkingHours)) + geom_bar(stat = "identity")
```
